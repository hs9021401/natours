...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiaHM5MDIxNDAxIiwiYSI6ImNrODYxN3J6dTBjdTEzbXA4N214eXQwODIifQ.KEg_9CbqxIVlWf3XY1d5CA';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/hs9021401/ck8625vwr0ol01intss4pwqbq',
    scrollZoom: false // center: [-118.334172, 34.207568],
    // zoom: 15
...
var stripe = Stripe('pk_test_AM6a9i29a6CDotMkRvX0Hnjz004FC1Wrtm');
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            console.log('Book tour!!!'); //1) Get checkout session from API
...
var updatePassForm = document.querySelector('.form.form-user-password');
...
if (loginForm) {
  loginForm.addEventListener('submit', function (e) {
    ...
    e.preventDefault(); //我們不能把下面兩行放到外面一層, 因為還未被定義, 所以會取得undefined值, 只有在login form畫面下才有辦法正確得到email/password的值
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "2049" + '/');
